    ...
    public class CommunicationDetail : RockBlockType
    {
            ...
            get
            {
                if ( _recipientGridAttributeColumns == null )
                {
                    ...
                    var guids = new List<Guid>
                        {
                            new Guid( "D42763FA-28E9-4A55-A25A-48998D7D7FEF" ) // Baptism Date
                            , new Guid( "4ABF0BF2-49BA-4363-9D85-AC48A0F7E92A" ) // Ability Level
                            , new Guid( "BF5F86FD-7BFB-491F-91DE-6A2E4E9FD4CC" ) // Employer
                            , new Guid( "655D6FBA-F8C0-4919-9E31-C1C936653555" ) // First Visit
                        };
        ...
        public BlockActionResult GetRecipientGridData()
        {
            ...
            foreach ( var row in communicationWithRecipientRows.RecipientRows )
            {
                ...
                TrySetLastActivityDateTime( row, row.OpenedDateTime );
                TrySetLastActivityDateTime( row, row.UnsubscribedDateTime );
                TrySetLastActivityDateTime( row, row.MarkedAsSpamDateTime );
                ...
                if ( groupedInteractions.AllClicksByRecipientId.TryGetValue( row.CommunicationRecipientId, out var clicks ) && clicks.Any() )
                {
                    ...
                    TrySetLastActivityDateTime( row, row.ClickedDateTime );
                }
            }
        ...
        private GridBuilder<CommunicationRecipientRow> GetRecipientGridBuilder( CommunicationType communicationType )
        {
            var builder = new GridBuilder<CommunicationRecipientRow>()
                ...
                .AddField( "statusNote", r => r.StatusNote );

            if ( communicationType != CommunicationType.SMS )
            {
                builder.AddField( "openedDateTime", r => r.OpenedDateTime );
            }
        ...
        private class CommunicationRecipientRow
        {
            ...
            /// <summary>
            /// Gets or sets the last datetime this recipient opened this communication.
            /// </summary>
            public DateTime? OpenedDateTime { get; set; }

            /// <summary>
            /// Gets or sets the IP address from which this recipient last-opened this communication.
            /// </summary>
            public string OpenedIpAddress { get; set; }

            /// <summary>
            /// Gets or sets the client with which this recipient last-opened this communication.
            /// </summary>
            ...
            /// <summary>
            /// Gets or sets the last datetime this recipient clicked this communication.
            /// </summary>
            public DateTime? ClickedDateTime { get; set; }

            /// <summary>
            /// Gets or sets the IP address from which this recipient last-clicked a link within this communication.
            /// </summary>
            public string ClickedIpAddress { get; set; }

            /// <summary>
            /// Gets or sets the client with which this recipient last-clicked a link within this communication.
            /// </summary>
            public string ClickedClient { get; set; }

            ///// <summary>
            /// Gets or sets the datetime this recipient unsubscribed from this communication.
            /// </summary>
            public DateTime? UnsubscribedDateTime { get; set; }

            /// <summary>
            /// Gets or sets the datetime this recipient marked this communication as SPAM.
            /// </summary>
